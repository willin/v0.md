...
- Medis （Electron 封装的 OS X 客户端）： [https://github.com/luin/medis](https://github.com/luin/medis)
- Node.js 实现原理： [https://stackoverflow.com/questions/38689707/connecting-to-remote-ssh-server-via-node-js-html5-console](https://stackoverflow.com/questions/38689707/connecting-to-remote-ssh-server-via-node-js-html5-console)
