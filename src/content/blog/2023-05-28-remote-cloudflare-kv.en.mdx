---
title: "Use remote-cloudflare-kv on Vercel"
description: "https://github.com/willin/remote-cloudflare-kv"
categories:
  - tech
tags:
  - cloudflare
...
- Runtime API: [https://developers.cloudflare.com/workers/runtime-apis/kv/](https://developers.cloudflare.com/workers/runtime-apis/kv/)
- RESTful API: [https://developers.cloudflare.com/api/operations/workers-kv-namespace-list-namespaces](https://developers.cloudflare.com/api/operations/workers-kv-namespace-list-namespaces)

## Sponsor

Donation ways:

- Github: [https://github.com/sponsors/willin](https://github.com/sponsors/willin)
- Paypal: [https://paypal.me/willinwang](https://paypal.me/willinwang)
