...
import { IsEmail, IsMobilePhone, IsEnum, IsOptional, IsString } from 'class-validator';
...
// 定义好单一对象参数的类型
export type UpdateUserDto = Partial<Pick<UserEntity, 'role' | 'username' | 'email' | 'mobile' | 'passwd'>>;
 ...
 * @returns {boolean}
 */
export async function updateUser(id: string, data: UpdateUserDto): Promise<boolean> {
...
更多实用的容器参考项目： [https://github.com/WhiteMatrixTech/dev-in-docker](https://github.com/WhiteMatrixTech/dev-in-docker)
